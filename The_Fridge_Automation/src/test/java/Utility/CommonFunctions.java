...
public class CommonFunctions {
	 ...
	 * 
	 * DateFormat dateFormat = new SimpleDateFormat(ReqDateFormate); Date date = new
...
//			}
	...
	/*
	 * public String DateFormateConvert(String PrasentDateFormate, String
	 * ExpectedDateFormate, String Valu) throws ParseException { SimpleDateFormat
	 * dateFormat = new SimpleDateFormat(PrasentDateFormate); Date myDate =
	 * dateFormat.parse(Valu);
	 * 
	 * SimpleDateFormat dateFormat2 = new SimpleDateFormat(ExpectedDateFormate);
	 * String Result = dateFormat2.format(myDate);
	 * System.out.println("*********Date Formate Changed Successfully*******" + "  "
